...
const commercialWorkspaceRentModel = require('../models/commercialWorkspaceRentModel');
...
exports.postRentCommercialWorkspace = async (req, res) => {
  try {
    ...
    if (/^\d/.test(placePart)) {
      ...
      if (match) {
        ...
        const id = await commercialWorkspaceRentModel.addCommercialWorkspaceRent(req.body);
...
exports.getAllCommercialWorkspaceRentProperties = async (req, res) => {
  try {
    const properties = await commercialWorkspaceRentModel.getAllCommercialWorkspaceRent();
    res.json({ properties });
  } catch (error) {
...
exports.filterCommercialWorkspaceRentProperties = async (req, res) => {
  try {
    const { state, city, pincode, min, max } = req.body;
    const prop = await commercialWorkspaceRentModel.filterCommercialWorkspaceRent(state, city, pincode, min, max);
    res.json({ prop });
  } catch (error) {
...
exports.filterMapRentCommercialWorkspace = async (req, res) => {
  try {
