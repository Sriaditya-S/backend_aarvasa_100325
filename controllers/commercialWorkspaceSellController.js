...
const commercialWorkspaceSellModel = require('../models/commercialWorkspaceSellModel');
...
exports.postSellCommercialWorkspace = async (req, res) => {
  try {
    ...
    if (/^\d/.test(placePart)) {
      ...
      if (match) {
        ...
        const id = await commercialWorkspaceSellModel.addCommercialWorkspaceSell(req.body);
...
exports.getAllCommercialWorkspaceSaleProperties = async (req, res) => {
  try {
    const properties = await commercialWorkspaceSellModel.getAllCommercialWorkspaceSell();
    res.json({ properties });
  } catch (error) {
...
exports.filterCommercialWorkspaceSaleProperties = async (req, res) => {
  try {
    const { state, city, pincode, min, max } = req.body;
    const prop = await commercialWorkspaceSellModel.filterCommercialWorkspaceSell(state, city, pincode, min, max);
    res.json({ prop });
  } catch (error) {
...
exports.filterMapSaleCommercialWorkspace = async (req, res) => {
  try {
